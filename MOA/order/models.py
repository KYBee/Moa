...
class Order(models.Model):
    ...
    target_people = models.CharField(verbose_name="펀딩 희망 인원", max_length = 5, blank=True, null=True)
    target_money = models.CharField(verbose_name="펀딩 필요 금액", max_length = 5, blank=True, null=True)
